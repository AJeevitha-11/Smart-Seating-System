...
**Project Description**
The Smart Exam Seating System is a web application developed using Django to automate the process of arranging students in exam halls.
...
**Features**
 -Upload student details using Excel files
